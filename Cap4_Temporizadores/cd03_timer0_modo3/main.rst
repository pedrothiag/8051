      ...
      000049 12 00 C0         [24]  404 	lcall	_main
      ...
      00004C 80 FE            [24]  406 	sjmp	.
                                    ...
                                    411 	.area CSEG    (CODE)
                                    412 ;------------------------------------------------------------
                                    413 ;Allocation info for local variables in function 'timer_setup'
                                    414 ;------------------------------------------------------------
                                    415 ;	main.c:16: void timer_setup(void) {
                                    416 ;	-----------------------------------------
                                    417 ;	 function timer_setup
                                    418 ;	-----------------------------------------
      0000AA                        419 _timer_setup:
                           000007   420 	ar7 = 0x07
                           000006   421 	ar6 = 0x06
                           000005   422 	ar5 = 0x05
                           000004   423 	ar4 = 0x04
                           ...
                           000001   426 	ar1 = 0x01
                           000000   427 	ar0 = 0x00
                                    428 ;	main.c:17: TMOD = 0x33;               /* TIMER0 em Modo 3 */
      0000AA 75 89 33         [24]  429 	mov	_TMOD,#0x33
                                    430 ;	main.c:18: TR0 = 0;                   /* Desligar TL0. */
                                    431 ;	assignBit
      0000AD C2 8C            [12]  432 	clr	_TR0
                                    433 ;	main.c:19: TR1 = 0;                   /* Desligar TH0. */
                                    434 ;	assignBit
      0000AF C2 8E            [12]  435 	clr	_TR1
                                    436 ;	main.c:21: TL0 = 0x06;                /* 250us */
      0000B1 75 8A 06         [24]  437 	mov	_TL0,#0x06
                                    438 ;	main.c:22: TH0 = 0x9C;                /* 100us */
      0000B4 75 8C 9C         [24]  439 	mov	_TH0,#0x9c
                                    440 ;	main.c:24: TF0 = 0;             /* Limpa a flag de TL0. */
                                    441 ;	assignBit
      0000B7 C2 8D            [12]  442 	clr	_TF0
                                    443 ;	main.c:25: TF1 = 0;             /* Limpa a flag de TH0. */
                                    444 ;	assignBit
      0000B9 C2 8F            [12]  445 	clr	_TF1
                                    446 ;	main.c:26: TR0 = 1;                   /* Inicia TL0. */
                                    447 ;	assignBit
      0000BB D2 8C            [12]  448 	setb	_TR0
                                    449 ;	main.c:27: TR1 = 1;                   /* Inicia TH0. */
                                    450 ;	assignBit
      0000BD D2 8E            [12]  451 	setb	_TR1
                                    452 ;	main.c:28: }
      0000BF 22               [24]  453 	ret
                                    454 ;------------------------------------------------------------
                                    455 ;Allocation info for local variables in function 'main'
                                    456 ;------------------------------------------------------------
                                    457 ;	main.c:30: void main(void) {
                                    458 ;	-----------------------------------------
                                    459 ;	 function main
                                    460 ;	-----------------------------------------
      0000C0                        461 _main:
                                    462 ;	main.c:31: SAIDA_0 = 0;
                                    463 ;	assignBit
      0000C0 C2 90            [12]  464 	clr	_P1_0
                                    465 ;	main.c:32: SAIDA_1 = 0;
                                    466 ;	assignBit
      0000C2 C2 91            [12]  467 	clr	_P1_1
                                    468 ;	main.c:33: timer_setup();
      0000C4 12 00 AA         [24]  469 	lcall	_timer_setup
                                    470 ;	main.c:35: while (1) {
      0000C7                        471 00106$:
                                    472 ;	main.c:36: if (TF0 != 0) {
      0000C7 30 8D 0B         [24]  473 	jnb	_TF0,00102$
                                    474 ;	main.c:37: TR0 = 0;   /* Para TL0 para recarregar. */
                                    475 ;	assignBit
      0000CA C2 8C            [12]  476 	clr	_TR0
                                    477 ;	main.c:38: TL0 = 0x06;
      0000CC 75 8A 06         [24]  478 	mov	_TL0,#0x06
                                    479 ;	main.c:39: TF0 = 0;
                                    480 ;	assignBit
      0000CF C2 8D            [12]  481 	clr	_TF0
                                    482 ;	main.c:40: SAIDA_0 = !SAIDA_0;
      0000D1 B2 90            [12]  483 	cpl	_P1_0
                                    484 ;	main.c:41: TR0 = 1;
                                    485 ;	assignBit
      0000D3 D2 8C            [12]  486 	setb	_TR0
      0000D5                        487 00102$:
                                    488 ;	main.c:43: if (TF1 != 0) {
      0000D5 30 8F EF         [24]  489 	jnb	_TF1,00106$
                                    490 ;	main.c:44: TR1 = 0;   /* Para TH0 para recarregar. */
                                    491 ;	assignBit
      0000D8 C2 8E            [12]  492 	clr	_TR1
                                    493 ;	main.c:45: TH0 = 0x9C;
      0000DA 75 8C 9C         [24]  494 	mov	_TH0,#0x9c
                                    495 ;	main.c:46: TF1 = 0;
                                    496 ;	assignBit
      0000DD C2 8F            [12]  497 	clr	_TF1
                                    498 ;	main.c:47: SAIDA_1 = !SAIDA_1;
      0000DF B2 91            [12]  499 	cpl	_P1_1
                                    500 ;	main.c:48: TR1 = 1;
                                    501 ;	assignBit
      0000E1 D2 8E            [12]  502 	setb	_TR1
                                    503 ;	main.c:51: }
      0000E3 80 E2            [24]  504 	sjmp	00106$
                                    505 	.area CSEG    (CODE)
                                    506 	.area CONST   (CODE)
                                    507 	.area XINIT   (CODE)
