                                     ...
                                     11 	.globl _main
                                     12 	.globl _delay_ms
                                     13 	.globl _timer_250us
                                     14 	.globl _timer_setup
                                     15 	.globl _TF2
                                     16 	.globl _EXF2
                                     17 	.globl _RCLK
                                     18 	.globl _TCLK
      ...
      000049 12 00 F2         [24]  406 	lcall	_main
      ...
      00004C 80 FE            [24]  408 	sjmp	.
                                    ...
                                    413 	.area CSEG    (CODE)
                                    414 ;------------------------------------------------------------
                                    415 ;Allocation info for local variables in function 'timer_setup'
                                    416 ;------------------------------------------------------------
                                    417 ;	main.c:15: void timer_setup(void) {
                                    418 ;	-----------------------------------------
                                    419 ;	 function timer_setup
                                    420 ;	-----------------------------------------
      0000AA                        421 _timer_setup:
                           000007   422 	ar7 = 0x07
                           000006   423 	ar6 = 0x06
                           000005   424 	ar5 = 0x05
                           000004   425 	ar4 = 0x04
                           ...
                           000001   428 	ar1 = 0x01
                           000000   429 	ar0 = 0x00
                                    430 ;	main.c:16: TR0 = 0;       // Mantem o Timer 0 parado
                                    431 ;	assignBit
      0000AA C2 8C            [12]  432 	clr	_TR0
                                    433 ;	main.c:17: TMOD &= 0xF0;  // Limpa a configuracao do Timer 0
      0000AC 53 89 F0         [24]  434 	anl	_TMOD,#0xf0
                                    435 ;	main.c:18: TMOD |= 0x02;  // Timer 0 no Modo 2
      0000AF 43 89 02         [24]  436 	orl	_TMOD,#0x02
                                    437 ;	main.c:19: TH0 = 0x06;    // Recarga: 256 - 250 = 6
      0000B2 75 8C 06         [24]  438 	mov	_TH0,#0x06
                                    439 ;	main.c:21: TL0 = 0x06;
      0000B5 75 8A 06         [24]  440 	mov	_TL0,#0x06
                                    441 ;	main.c:22: TF0 = 0;       // Limpa o flag de estouro
                                    442 ;	assignBit
      0000B8 C2 8D            [12]  443 	clr	_TF0
                                    444 ;	main.c:23: }
      0000BA 22               [24]  445 	ret
                                    446 ;------------------------------------------------------------
                                    447 ;Allocation info for local variables in function 'timer_250us'
                                    448 ;------------------------------------------------------------
                                    449 ;	main.c:25: void timer_250us(void) {
                                    450 ;	-----------------------------------------
                                    451 ;	 function timer_250us
                                    452 ;	-----------------------------------------
      0000BB                        453 _timer_250us:
                                    454 ;	main.c:26: while (TF0 == 0);
      0000BB                        455 00101$:
                                    456 ;	main.c:27: TF0 = 0;  // Limpa o flag para o proximo estouro
                                    457 ;	assignBit
      0000BB 10 8D 02         [24]  458 	jbc	_TF0,00120$
      0000BE 80 FB            [24]  459 	sjmp	00101$
      0000C0                        460 00120$:
                                    461 ;	main.c:28: }
      0000C0 22               [24]  462 	ret
                                    463 ;------------------------------------------------------------
                                    464 ;Allocation info for local variables in function 'delay_ms'
                                    465 ;------------------------------------------------------------
                                    466 ;ms            Allocated to registers r6 r7 
                                    467 ;------------------------------------------------------------
                                    468 ;	main.c:30: void delay_ms(unsigned int ms) {
                                    469 ;	-----------------------------------------
                                    470 ;	 function delay_ms
                                    471 ;	-----------------------------------------
      0000C1                        472 _delay_ms:
      0000C1 AE 82            [24]  473 	mov	r6, dpl
      0000C3 AF 83            [24]  474 	mov	r7, dph
                                    475 ;	main.c:32: TR0 = 0;
                                    476 ;	assignBit
      0000C5 C2 8C            [12]  477 	clr	_TR0
                                    478 ;	main.c:33: TL0 = 0x06;  // Reinicia a primeira contagem
      0000C7 75 8A 06         [24]  479 	mov	_TL0,#0x06
                                    480 ;	main.c:34: TF0 = 0;     // Limpa um possivel flag anterior
                                    481 ;	assignBit
      0000CA C2 8D            [12]  482 	clr	_TF0
                                    483 ;	main.c:35: TR0 = 1;     // Inicia o Timer 0
                                    484 ;	assignBit
      0000CC D2 8C            [12]  485 	setb	_TR0
                                    486 ;	main.c:36: while (ms-- > 0) {
      0000CE                        487 00101$:
      0000CE 8E 04            [24]  488 	mov	ar4,r6
      0000D0 8F 05            [24]  489 	mov	ar5,r7
      0000D2 1E               [12]  490 	dec	r6
      0000D3 BE FF 01         [24]  491 	cjne	r6,#0xff,00121$
      0000D6 1F               [12]  492 	dec	r7
      0000D7                        493 00121$:
      0000D7 EC               [12]  494 	mov	a,r4
      0000D8 4D               [12]  495 	orl	a,r5
      0000D9 60 16            [24]  496 	jz	00104$
                                    497 ;	main.c:37: timer_250us();
      0000DB C0 07            [24]  498 	push	ar7
      0000DD C0 06            [24]  499 	push	ar6
      0000DF 12 00 BB         [24]  500 	lcall	_timer_250us
                                    501 ;	main.c:38: timer_250us();
      0000E2 12 00 BB         [24]  502 	lcall	_timer_250us
                                    503 ;	main.c:39: timer_250us();
      0000E5 12 00 BB         [24]  504 	lcall	_timer_250us
                                    505 ;	main.c:40: timer_250us();
      0000E8 12 00 BB         [24]  506 	lcall	_timer_250us
      0000EB D0 06            [24]  507 	pop	ar6
      0000ED D0 07            [24]  508 	pop	ar7
      0000EF 80 DD            [24]  509 	sjmp	00101$
      0000F1                        510 00104$:
                                    511 ;	main.c:42: }
      0000F1 22               [24]  512 	ret
                                    513 ;------------------------------------------------------------
                                    514 ;Allocation info for local variables in function 'main'
                                    515 ;------------------------------------------------------------
                                    516 ;	main.c:44: void main(void) {
                                    517 ;	-----------------------------------------
                                    518 ;	 function main
                                    519 ;	-----------------------------------------
      0000F2                        520 _main:
                                    521 ;	main.c:45: LED = 1;
                                    522 ;	assignBit
      0000F2 D2 90            [12]  523 	setb	_P1_0
                                    524 ;	main.c:46: timer_setup();
      0000F4 12 00 AA         [24]  525 	lcall	_timer_setup
                                    526 ;	main.c:47: while (1) {
      0000F7                        527 00102$:
                                    528 ;	main.c:48: LED = !LED;     // Inverte o estado do LED
      0000F7 B2 90            [12]  529 	cpl	_P1_0
                                    530 ;	main.c:49: delay_ms(500);  // Aproximadamente 500 ms
      0000F9 90 01 F4         [24]  531 	mov	dptr,#0x01f4
      0000FC 12 00 C1         [24]  532 	lcall	_delay_ms
                                    533 ;	main.c:51: }
      0000FF 80 F6            [24]  534 	sjmp	00102$
                                    535 	.area CSEG    (CODE)
                                    536 	.area CONST   (CODE)
                                    537 	.area XINIT   (CODE)
