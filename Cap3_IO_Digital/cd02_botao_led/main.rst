      ...
      0000AA                        418 _main:
                           ...
                           000001   425 	ar1 = 0x01
                           000000   426 	ar0 = 0x00
                                    427 ;	main.c:17: BOTAO = 1;  // configura P3.2 como entrada
                                    428 ;	assignBit
      0000AA D2 B2            [12]  429 	setb	_P3_2
                                    430 ;	main.c:18: while (1) {
      0000AC                        431 00105$:
                                    432 ;	main.c:20: if (BOTAO == 0)
      0000AC 20 B2 04         [24]  433 	jb	_P3_2,00102$
                                    434 ;	main.c:21: LED = 0;  // acende
                                    435 ;	assignBit
      0000AF C2 90            [12]  436 	clr	_P1_0
      0000B1 80 F9            [24]  437 	sjmp	00105$
      0000B3                        438 00102$:
                                    439 ;	main.c:23: LED = 1;  // apaga
                                    440 ;	assignBit
      0000B3 D2 90            [12]  441 	setb	_P1_0
                                    442 ;	main.c:25: }
      0000B5 80 F5            [24]  443 	sjmp	00105$
                                    444 	.area CSEG    (CODE)
                                    445 	.area CONST   (CODE)
                                    446 	.area XINIT   (CODE)
