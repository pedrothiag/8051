      ...
      00004C 80 FE            [24]  411 	sjmp	.
                                    ...
                                    423 ;------------------------------------------------------------
                                    424 ;	main.c:16: void delay_ms(unsigned int ms) { 
                                    425 ;	-----------------------------------------
      ...
      0000EA 22               [24]  483 	ret
                                    ...
                                    486 ;------------------------------------------------------------
                                    487 ;	main.c:22: void main(void) {
                                    488 ;	-----------------------------------------
                                    489 ;	 function main
                                    490 ;	-----------------------------------------
      0000EB                        491 _main:
                                    492 ;	main.c:23: BOTAO = 1;
                                    493 ;	assignBit
      0000EB D2 B2            [12]  494 	setb	_P3_2
                                    495 ;	main.c:24: LED = 1;
                                    496 ;	assignBit
      0000ED D2 90            [12]  497 	setb	_P1_0
                                    498 ;	main.c:25: while (1) {
      0000EF                        499 00109$:
                                    500 ;	main.c:26: if (BOTAO == 0) {      // parece pressionado
      0000EF 20 B2 FD         [24]  501 	jb	_P3_2,00109$
                                    502 ;	main.c:28: delay_ms(20);
      0000F2 90 00 14         [24]  503 	mov	dptr,#0x0014
      0000F5 12 00 AA         [24]  504 	lcall	_delay_ms
                                    505 ;	main.c:29: if (BOTAO == 0) {  // confirma
      0000F8 20 B2 F4         [24]  506 	jb	_P3_2,00109$
                                    507 ;	main.c:30: LED = !LED;    // alterna o LED
      0000FB B2 90            [12]  508 	cpl	_P1_0
                                    509 ;	main.c:32: while (BOTAO == 0);
      0000FD                        510 00101$:
      0000FD 30 B2 FD         [24]  511 	jnb	_P3_2,00101$
                                    512 ;	main.c:36: }
      000100 80 ED            [24]  513 	sjmp	00109$
                                    514 	.area CSEG    (CODE)
                                    515 	.area CONST   (CODE)
                                    516 	.area XINIT   (CODE)
