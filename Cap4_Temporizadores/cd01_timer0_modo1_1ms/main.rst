      ...
      000049 12 00 E6         [24]  406 	lcall	_main
      ...
      0000AA                        421 _timer_setup:
                           ...
                           000001   428 	ar1 = 0x01
                           000000   429 	ar0 = 0x00
                                    430 ;	main.c:16: TMOD &= 0xF0;  // Limpa o modo do temporizador 0
      0000AA 53 89 F0         [24]  431 	anl	_TMOD,#0xf0
                                    432 ;	main.c:18: TMOD |= 0x01;
      0000AD 43 89 01         [24]  433 	orl	_TMOD,#0x01
                                    434 ;	main.c:19: TF0 = 0;       // Limpa TF0
                                    435 ;	assignBit
      0000B0 C2 8D            [12]  436 	clr	_TF0
                                    437 ;	main.c:20: TR0 = 0;       // Deixa o temporizador 0 parado
                                    438 ;	assignBit
      0000B2 C2 8C            [12]  439 	clr	_TR0
                                    440 ;	main.c:21: }
      0000B4 22               [24]  441 	ret
                                    442 ;------------------------------------------------------------
                                    443 ;Allocation info for local variables in function 'timer_1ms'
                                    444 ;------------------------------------------------------------
                                    445 ;	main.c:23: void timer_1ms(void) {
                                    446 ;	-----------------------------------------
                                    447 ;	 function timer_1ms
                                    448 ;	-----------------------------------------
      0000B5                        449 _timer_1ms:
                                    450 ;	main.c:24: TR0 = 0;     // Para o temporizador 0
                                    451 ;	assignBit
      0000B5 C2 8C            [12]  452 	clr	_TR0
                                    453 ;	main.c:25: TH0 = 0xFC;  // Valor inicial: 0xFC18
      0000B7 75 8C FC         [24]  454 	mov	_TH0,#0xfc
                                    455 ;	main.c:26: TL0 = 0x18;
      0000BA 75 8A 18         [24]  456 	mov	_TL0,#0x18
                                    457 ;	main.c:27: TR0 = 1;           // Inicia o temporizador 0
                                    458 ;	assignBit
      0000BD D2 8C            [12]  459 	setb	_TR0
                                    460 ;	main.c:28: while (TF0 == 0);  // Aguarda o estouro
      0000BF                        461 00101$:
      0000BF 30 8D FD         [24]  462 	jnb	_TF0,00101$
                                    463 ;	main.c:29: TR0 = 0;           // Para o temporizador 0
                                    464 ;	assignBit
      0000C2 C2 8C            [12]  465 	clr	_TR0
                                    466 ;	main.c:30: TF0 = 0;           // Limpa TF0
                                    467 ;	assignBit
      0000C4 C2 8D            [12]  468 	clr	_TF0
                                    469 ;	main.c:31: }
      0000C6 22               [24]  470 	ret
                                    471 ;------------------------------------------------------------
                                    472 ;Allocation info for local variables in function 'delay_ms'
                                    473 ;------------------------------------------------------------
                                    474 ;n             Allocated to registers 
                                    475 ;------------------------------------------------------------
                                    476 ;	main.c:33: void delay_ms(unsigned int n) {
                                    477 ;	-----------------------------------------
                                    478 ;	 function delay_ms
                                    479 ;	-----------------------------------------
      0000C7                        480 _delay_ms:
      0000C7 AE 82            [24]  481 	mov	r6, dpl
      0000C9 AF 83            [24]  482 	mov	r7, dph
                                    483 ;	main.c:34: while (n--)
      0000CB                        484 00101$:
      0000CB 8E 04            [24]  485 	mov	ar4,r6
      0000CD 8F 05            [24]  486 	mov	ar5,r7
      0000CF 1E               [12]  487 	dec	r6
      0000D0 BE FF 01         [24]  488 	cjne	r6,#0xff,00121$
      0000D3 1F               [12]  489 	dec	r7
      0000D4                        490 00121$:
      0000D4 EC               [12]  491 	mov	a,r4
      0000D5 4D               [12]  492 	orl	a,r5
      0000D6 60 0D            [24]  493 	jz	00104$
                                    494 ;	main.c:35: timer_1ms();
      0000D8 C0 07            [24]  495 	push	ar7
      0000DA C0 06            [24]  496 	push	ar6
      0000DC 12 00 B5         [24]  497 	lcall	_timer_1ms
      0000DF D0 06            [24]  498 	pop	ar6
      0000E1 D0 07            [24]  499 	pop	ar7
      0000E3 80 E6            [24]  500 	sjmp	00101$
      0000E5                        501 00104$:
                                    502 ;	main.c:36: }
      0000E5 22               [24]  503 	ret
                                    504 ;------------------------------------------------------------
                                    505 ;Allocation info for local variables in function 'main'
                                    506 ;------------------------------------------------------------
                                    507 ;	main.c:38: void main(void) {
                                    508 ;	-----------------------------------------
                                    509 ;	 function main
                                    510 ;	-----------------------------------------
      0000E6                        511 _main:
                                    512 ;	main.c:39: timer_setup();
      0000E6 12 00 AA         [24]  513 	lcall	_timer_setup
                                    514 ;	main.c:40: while (1) {
      0000E9                        515 00102$:
                                    516 ;	main.c:41: LED = !LED;     // Inverte o estado do LED
      0000E9 B2 90            [12]  517 	cpl	_P1_0
                                    518 ;	main.c:42: delay_ms(200);  // Aproximadamente 500 ms
      0000EB 90 00 C8         [24]  519 	mov	dptr,#0x00c8
      0000EE 12 00 C7         [24]  520 	lcall	_delay_ms
                                    521 ;	main.c:44: }
      0000F1 80 F6            [24]  522 	sjmp	00102$
                                    523 	.area CSEG    (CODE)
                                    524 	.area CONST   (CODE)
                                    525 	.area XINIT   (CODE)
