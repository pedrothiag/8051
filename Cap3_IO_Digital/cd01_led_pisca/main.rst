      ...
      00004C 80 FE            [24]  411 	sjmp	.
                                    ...
                                    423 ;------------------------------------------------------------
                                    424 ;	main.c:15: void delay_ms(unsigned int ms) {
                                    425 ;	-----------------------------------------
      ...
      0000EA 22               [24]  483 	ret
                                    ...
                                    490 ;	-----------------------------------------
      0000EB                        491 _main:
                                    492 ;	main.c:23: while (1) {
      0000EB                        493 00102$:
                                    494 ;	main.c:24: LED = 0;  // nivel baixo -> LED acende
                                    495 ;	assignBit
      0000EB C2 90            [12]  496 	clr	_P1_0
                                    497 ;	main.c:25: delay_ms(500);
      0000ED 90 01 F4         [24]  498 	mov	dptr,#0x01f4
      0000F0 12 00 AA         [24]  499 	lcall	_delay_ms
                                    500 ;	main.c:26: LED = 1;  // nivel alto  -> LED apaga
                                    501 ;	assignBit
      0000F3 D2 90            [12]  502 	setb	_P1_0
                                    503 ;	main.c:27: delay_ms(500);
      0000F5 90 01 F4         [24]  504 	mov	dptr,#0x01f4
      0000F8 12 00 AA         [24]  505 	lcall	_delay_ms
                                    506 ;	main.c:29: }
      0000FB 80 EE            [24]  507 	sjmp	00102$
                                    508 	.area CSEG    (CODE)
                                    509 	.area CONST   (CODE)
                                    510 	.area XINIT   (CODE)
